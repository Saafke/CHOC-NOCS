...
class Config(object):
    ...
    # Image mean (RGB)
    #MEAN_PIXEL = np.array([123.7, 116.8, 103.9]) #NOCS OG
    #MEAN_PIXEL = np.array([119.736946, 124.18394, 124.87332]) # MINE TRAIN
    #MEAN_PIXEL = [118.863686 123.231926 124.11887] # MINE VAL 
    ...
    def __init__(self):
        ...
        self.IMAGE_SHAPE = np.array(
            [self.IMAGE_MAX_DIM, self.IMAGE_MAX_DIM, 3]) #MAX
